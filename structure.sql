...
--
-- Name: postimages; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.postimages OWNER TO admin;

--
-- Name: postimages_pk_bint_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.postimages_pk_bint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.postimages_pk_bint_id_seq OWNER TO admin;

--
-- Name: postimages_pk_bint_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.postimages_pk_bint_id_seq OWNED BY public.postimages.pk_bint_id;
...
--
-- Name: posts_pk_bint_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.posts_pk_bint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.posts_pk_bint_id_seq OWNER TO admin;

--
-- Name: posts_pk_bint_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.posts_pk_bint_id_seq OWNED BY public.posts.pk_bint_id;


--
-- Name: reacts; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.reacts OWNER TO admin;

--
-- Name: reacts_pk_bint_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.reacts_pk_bint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.reacts_pk_bint_id_seq OWNER TO admin;

--
-- Name: reacts_pk_bint_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.reacts_pk_bint_id_seq OWNED BY public.reacts.pk_bint_id;


--
-- Name: tagweight; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.tagweight (
    pk_bint_id bigint NOT NULL,
...
ALTER TABLE public.tagweight OWNER TO admin;

--
-- Name: tagweight_pk_bint_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.tagweight_pk_bint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.tagweight_pk_bint_id_seq OWNER TO admin;

--
-- Name: tagweight_pk_bint_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.tagweight_pk_bint_id_seq OWNED BY public.tagweight.pk_bint_id;
...
--
-- Name: postimages pk_bint_id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.postimages ALTER COLUMN pk_bint_id SET DEFAULT nextval('public.postimages_pk_bint_id_seq'::regclass);


--
-- Name: posts pk_bint_id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.posts ALTER COLUMN pk_bint_id SET DEFAULT nextval('public.posts_pk_bint_id_seq'::regclass);


--
-- Name: reacts pk_bint_id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.reacts ALTER COLUMN pk_bint_id SET DEFAULT nextval('public.reacts_pk_bint_id_seq'::regclass);


--
-- Name: tagweight pk_bint_id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tagweight ALTER COLUMN pk_bint_id SET DEFAULT nextval('public.tagweight_pk_bint_id_seq'::regclass);
...
--
-- Name: postimages postimages_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.postimages
    ADD CONSTRAINT postimages_pkey PRIMARY KEY (pk_bint_id);
...
ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_pkey PRIMARY KEY (pk_bint_id);


--
-- Name: reacts reacts_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.reacts
    ADD CONSTRAINT reacts_pkey PRIMARY KEY (pk_bint_id);


--
-- Name: tagweight tagweight_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tagweight
    ADD CONSTRAINT tagweight_pkey PRIMARY KEY (pk_bint_id);
...
--
-- Name: postimages_fk_post_id_21e6d4d4; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX postimages_fk_post_id_21e6d4d4 ON public.postimages USING btree (fk_post_id);


--
-- Name: reacts_fk_post_id_5dbc2a61; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX reacts_fk_post_id_5dbc2a61 ON public.reacts USING btree (fk_post_id);


--
-- Name: reacts_fk_user_id_967e8ed0; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX reacts_fk_user_id_967e8ed0 ON public.reacts USING btree (fk_user_id);


--
-- Name: tagweight_fk_post_id_89f6c309; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX tagweight_fk_post_id_89f6c309 ON public.tagweight USING btree (fk_post_id);
...
--
-- Name: postimages postimages_fk_post_id_21e6d4d4_fk_posts_pk_bint_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.postimages
    ADD CONSTRAINT postimages_fk_post_id_21e6d4d4_fk_posts_pk_bint_id FOREIGN KEY (fk_post_id) REFERENCES public.posts(pk_bint_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: reacts reacts_fk_post_id_5dbc2a61_fk_posts_pk_bint_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.reacts
    ADD CONSTRAINT reacts_fk_post_id_5dbc2a61_fk_posts_pk_bint_id FOREIGN KEY (fk_post_id) REFERENCES public.posts(pk_bint_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: reacts reacts_fk_user_id_967e8ed0_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.reacts
    ADD CONSTRAINT reacts_fk_user_id_967e8ed0_fk_auth_user_id FOREIGN KEY (fk_user_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: tagweight tagweight_fk_post_id_89f6c309_fk_posts_pk_bint_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tagweight
    ADD CONSTRAINT tagweight_fk_post_id_89f6c309_fk_posts_pk_bint_id FOREIGN KEY (fk_post_id) REFERENCES public.posts(pk_bint_id) DEFERRABLE INITIALLY DEFERRED;
